...
"À esquerda, a fronteira de decisão aprendida: o fundo é um heatmap da probabilidade prevista, e a reta é onde p é igual a 0,5. Como o modelo é linear, a fronteira é necessariamente uma reta, separando as duas gaussianas na diagonal. À direita, as métricas — essa tabela é de uma seed específica, a 42, só pra ilustrar: 95,4% de acurácia no treino e 96,7% no teste, com precisão, recall e F1 todos acima de 0,95. O número oficial, porém, é a média multi-seed: **96,3% ± 0,3%**, medida num dataset de teste bem maior. O gap pequeno entre treino e teste indica boa generalização, sem overfitting visível."

### Slide 4 — Conclusão *(3:55 – 5:00)*
"Concluindo: a implementação do zero está correta — os **96,3% ± 0,3%** de acurácia no teste, média sobre 10 seeds, confirmam o gradiente analítico. E o detalhe que fecha a história: o erro de teste, de 3,71% ± 0,27%, praticamente **encosta no limite de Bayes** de 3,57%, dado por Phi de menos raiz de 13 sobre 2 — a seed única tinha dado 3,33%, mas isso foi só sorte de amostra num teste pequeno. Isso mostra que o gargalo aqui é o **ruído intrínseco do problema**, não o modelo. Como limitações: por ser linear, a fronteira é uma reta — dados não-lineares exigiriam features polinomiais; e como melhorias eu aponto regularização L2 e um critério formal de parada. Obrigado."
