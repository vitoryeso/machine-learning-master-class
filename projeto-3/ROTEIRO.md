...
"O gráfico à esquerda mostra o MSE por época. O LMS, em vermelho, despenca em poucas épocas; o GD, em azul, desce devagar. A tabela confirma: o LMS chega a um MSE de **0,235**, praticamente colado no mínimo teórico de 0,25, com todos os pesos a menos de 0,04 dos verdadeiros. O GD fica em 0,48, quase o dobro. Mas atenção a um ponto metodológico importante: o GD **não convergiu de propósito**. Eu escolhi o learning rate 0,01 justamente pra evidenciar a sensibilidade do GD ao hiperparâmetro — não é uma comparação desequilibrada, é um experimento controlado pra mostrar o trade-off."
