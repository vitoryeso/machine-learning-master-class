...
"Com 30 centros por K-means, em full-dim: macro-grupo 0,93 de F1, screenshot vs foto 0,70, e pessoa vs não 0,67. As tarefas desbalanceadas são mais difíceis — com poucas gaussianas a rede cobre mal as regiões da classe rara. O gráfico à direita é a ablação principal: F1 contra o número de centros, para as três estratégias. A lição é clara: **a escolha dos centros importa**. O K-means vence em todos os valores de k, porque posiciona os centros onde os dados realmente estão; o aleatório fica perto; e o subconjunto fixo é o pior. E aumentar o número de centros melhora, com retorno decrescente."
