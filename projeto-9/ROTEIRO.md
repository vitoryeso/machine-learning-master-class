...
"E esta é a parte mais bonita: cada uma das 4 retas tracejadas é um neurônio oculto, e a rede **combina** essas retas numa região não-linear que isola o grupo laranja — é literalmente a camada oculta particionando o plano. Duas conclusões honestas. Primeira: MSE e cross-entropy deram quase o mesmo resultado aqui, então a escolha da perda importou pouco neste problema. Segunda, e mais interessante: uma rede com **zero** camadas ocultas — ou seja, uma regressão logística — já atinge F1 de 0,956. As features CLIP são tão ricas que ficam quase linearmente separáveis, e a não-linearidade do MLP agrega pouco em alta dimensão. Ela importa mesmo é no plano 2D comprimido, onde as classes se sobrepõem. Obrigado."
